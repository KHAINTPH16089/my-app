    ...
    return(
        ...
        <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <button className=" btn-edit flex justify-start  px-4 py-2 text-white rounded bg-indigo-500 hover:bg-indigo-800"><Link to={"/admin/product/add"}> thêm sản phẩm mới</Link></button>
